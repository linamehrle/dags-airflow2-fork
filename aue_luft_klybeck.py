...
- [100524](https://data.bs.ch/explore/dataset/100524)
- [100525](https://data.bs.ch/explore/dataset/100525)
- [100526](https://data.bs.ch/explore/dataset/100526)
"""
    ...
    upload = FailureTrackingDockerOperator(
        ...
        private_environment={
            **COMMON_ENV_VARS,
            ...
            "SHAREPOINT_SITE_NAME_AUE_LUFT_KLYBECK": Variable.get(
                "SHAREPOINT_SITE_NAME_AUE_LUFT_KLYBECK"
            ),
